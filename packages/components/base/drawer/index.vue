        ...
        <teleport to="body" :disabled="!appendToBody">
            <div ref="drawerRef" :class="_class">
                ...
                <transition :name="`move-${placement}`">
                    <div ref="dialogRef" class="em-drawer__dialog" :style="{ width: _width }" v-show="modelValue"
                        v-loading="loading">
                        <!--头部-->
                        ...
                        <!--拖拽按钮-->
                        <div v-if="draggable" class="em-drawer__drag"
                            :class="{ 'em-drawer__drag-left': placement === 'left' }" @mousedown="onTriggerMousedown">
                            <slot name="trigger">
                                <trigger />
                            </slot>
                        </div>
